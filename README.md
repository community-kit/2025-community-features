...
| <img src="https://github.com/community-kit/CommunityKit-Release-Feature-List/blob/main/Resources/Walletsmith/walletsmith.png" width="128" height="128" alt="Walletsmith icon"> | **Walletsmith**: Create your own Apple Wallet passes from scratch or any PDF or image using AI. | ![iOS](https://img.shields.io/badge/iOS-blue?logo=apple&logoColor=white) | [App Store](https://apps.apple.com/app/walletsmith/id1589618453) · [Website](https://www.walletsmith.app) |
---
